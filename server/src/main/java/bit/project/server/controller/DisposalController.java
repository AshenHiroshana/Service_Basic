...
public class DisposalController{
    ...
    public Disposal get(@PathVariable Integer id, HttpServletRequest request) {
        accessControlManager.authorize(request, "No privilege to get disposal", UsecaseList.SHOW_DISPOSAL_DETAILS, UsecaseList.UPDATE_DISPOSAL);
