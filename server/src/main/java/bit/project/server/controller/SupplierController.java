...
public class SupplierController{
    ...
    public Page<Supplier> getAllBasic(PageQuery pageQuery, HttpServletRequest request){
        accessControlManager.authorize(request, "No privilege to get all suppliers' basic data", UsecaseList.SHOW_ALL_SUPPLIERS, UsecaseList.ADD_ITEM, UsecaseList.UPDATE_ITEM, UsecaseList.ADD_PURCHASE, UsecaseList.UPDATE_PURCHASE, UsecaseList.ADD_PURCHASEORDER, UsecaseList.UPDATE_PURCHASEORDER, UsecaseList.ADD_SUPPLIERRETURN, UsecaseList.UPDATE_SUPPLIERRETURN);
