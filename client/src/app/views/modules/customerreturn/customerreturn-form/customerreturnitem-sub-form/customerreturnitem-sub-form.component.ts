...
@Component({
  selector: 'app-customerreturnitem-sub-form',
  templateUrl: './customerreturnitem-sub-form.component.html',
  styleUrls: ['./customerreturnitem-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CustomerreturnitemSubFormComponent),
      multi: true
    }, {
...
export class CustomerreturnitemSubFormComponent extends AbstractSubFormComponent<Customerreturnitem> implements OnInit{
