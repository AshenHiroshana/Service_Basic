...
import {Customerreturnitem} from '../../../../../entities/customerreturnitem';
import {Item} from '../../../../../entities/item';
import {ItemService} from '../../../../../services/item.service';

@Component({
  selector: 'app-customerreturnitem-update-sub-form',
  templateUrl: './customerreturnitem-update-sub-form.component.html',
  styleUrls: ['./customerreturnitem-update-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CustomerreturnitemUpdateSubFormComponent),
      multi: true
    }, {
...
export class CustomerreturnitemUpdateSubFormComponent extends AbstractSubFormComponent<Customerreturnitem> implements OnInit{
  ...
  fillForm(dataItem: Customerreturnitem): void {
  ...
  getDeleteConfirmMessage(customerreturnitem: Customerreturnitem): string {
    return 'Are you sure to remove \u201C ' + customerreturnitem.id + ' \u201D from returned items?';
  }

  getUpdateConfirmMessage(customerreturnitem: Customerreturnitem): string {
    if (this.isFormEmpty){
      return 'Are you sure to update \u201C\u00A0' + customerreturnitem.id + '\u00A0\u201D\u00A0?';
    }

    return 'Are you sure to update \u201C\u00A0' + customerreturnitem.id + '\u00A0\u201D and discard existing form data\u00A0?';
  }

  addData(): void{
    if (this.form.invalid) { return; }

    const dataItem: Customerreturnitem = new Customerreturnitem();
