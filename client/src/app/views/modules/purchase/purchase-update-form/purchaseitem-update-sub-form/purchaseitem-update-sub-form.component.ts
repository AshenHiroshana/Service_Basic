...
@Component({
  selector: 'app-purchaseitem-update-sub-form',
  templateUrl: './purchaseitem-update-sub-form.component.html',
  styleUrls: ['./purchaseitem-update-sub-form.component.scss'],
  providers: [
    {
...
export class PurchaseitemUpdateSubFormComponent extends AbstractSubFormComponent<Purchaseitem> implements OnInit{
